...
class PatientInfo:
    ...
    def create_widgets(self):
        # Title
        title_label = tk.Label(self.content_frame, text="Patient Information", 
        ...
        labels = ['Patient ID:', 'Name:', 'Gender:', 'Phone:', 'Address:', 
                  'Age:', 'Disease:', 'Blood Group:', 'Check In:']
        ...
        # Column settings
        widths = [20, 40, 50, 50, 30, 30, 50, 70, 60]
        ...
        self.display_records()
def load_patient_info(content_frame):
    return PatientInfo(content_frame)