...
def display_content(content_frame):
    doctor_info = DoctorInfo(content_frame)
...
class DoctorInfo:
    ...
    def add_doctor(self):
        try:
            ...
            cursor.execute('''
                INSERT INTO doctors (
                    doctor_id, name, gender, age, phone, address,
                    email, level, ward_no, area
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ''', values)
    ...
    def update_doctor(self):
        try:
            ...
            if cursor.rowcount == 0:
                ...
                self.clear_entries()
                self.display_records()
                messagebox.showinfo("Success", "Doctor information updated!")
    ...
    def create_widgets(self):
        # Title
        title_label = tk.Label(self.content_frame, text="Doctor Information", 
        ...
        # Entry fields
        labels = ['Doctor ID:', 'Name:', 'Gender:', 'Age:', 'Phone:', 'Address:', 
                 'Email:', 'Level:', 'Ward No.:', 'Area:']
        ...
        # Column settings
        widths = [30, 60, 80, 50, 100, 100, 100, 80, 80, 100]
